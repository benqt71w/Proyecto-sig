            ...
            <div class="row">
                <section class="posts col-md-9">
                    ...
                    <div class="post text-center">
                        <nav>
                            <div class="center-block">
                                <ul class="pagination">
                                    <?php
                                        $query = "select distinct subcategoria_producto from productos where categoria_producto='$categoria_actual' and oferta_producto is null";
                    ...
                    <!-- TERMINA BOTONES SUBCATEGORIAS-->
                        ...
                        if (!is_null($subcategoria_actual)) {
                            $query = "SELECT id_producto,nombre_producto,precio_producto,unidades_producto,imagen_producto FROM productos WHERE categoria_producto='$categoria_actual' AND subcategoria_producto='$subcategoria_actual' AND oferta_producto is null ORDER BY nombre_producto";
                            $result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
                        }
                        elseif(is_null($subcategoria_actual) and !is_null($categoria_actual)){
                            $query = "SELECT id_producto,nombre_producto,precio_producto,unidades_producto,imagen_producto FROM productos WHERE categoria_producto='$categoria_actual' AND oferta_producto is null ORDER BY nombre_producto";
                            $result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
                        }
                        elseif(is_null($categoria_actual)){
                            $query = "SELECT id_producto,nombre_producto,precio_producto,unidades_producto,imagen_producto FROM productos WHERE oferta_producto is null ORDER BY nombre_producto";
                            $result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
                        }
                        ...
                        if (!is_null($subcategoria_actual)) {
                            $query = "SELECT id_producto,nombre_producto,precio_producto,unidades_producto,descripcion_producto,imagen_producto FROM productos WHERE categoria_producto='$categoria_actual' AND subcategoria_producto='$subcategoria_actual' AND oferta_producto is null ORDER BY nombre_producto LIMIT $inicio_consulta,$articulos_por_pagina";
                            $result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
                        }
                        elseif(is_null($subcategoria_actual) and !is_null($categoria_actual)){
                            $query = "SELECT id_producto,nombre_producto,precio_producto,unidades_producto,descripcion_producto,imagen_producto FROM productos WHERE categoria_producto='$categoria_actual' AND oferta_producto is null ORDER BY nombre_producto LIMIT $inicio_consulta,$articulos_por_pagina";
                            $result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
                        }
                        elseif(is_null($categoria_actual)){
                            $query = "SELECT id_producto,nombre_producto,precio_producto,unidades_producto,descripcion_producto,imagen_producto FROM productos WHERE oferta_producto is null ORDER BY nombre_producto LIMIT $inicio_consulta,$articulos_por_pagina";
                            $result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
                        }
