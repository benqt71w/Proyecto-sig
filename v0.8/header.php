                    ...
                    <div class="collapse navbar-collapse" id="navegacion-dtq">
                        <ul class="nav navbar-nav">
                             ...
                             <li class="<?php if($pagina=='carrito'){ echo 'active';} ?>">
                                 <a href="carrito.php">Compras<span class="glyphicon glyphicon-shopping-cart"></span></a>
                             </li>
                             <?php
                                ...
                                if(session_status()==PHP_SESSION_ACTIVE){
                                    ...
                                    if (isset($_SESSION['usuario_activo'])){
                                        ...
                                        if($activo=='admin'){
                                            echo '<li><a href="admin.php">Administrar <span class="glyphicon glyphicon-list-alt"></span></a></li>';
                                            echo '<li><a href="logout.php?pag=1"><span class="glyphicon glyphicon-log-out"></span>Cerrar Sesion</a></li>';
                                        }
                                        else{
                                            echo '<li><a><span class="glyphicon glyphicon-user"></span> ¡Hola ',$activo,'!</a></li>';
